...
![Revision paths for Euro Area GDP (Sources: BEA,
Eurostat)](reference/figures/gdp_over_time.jpeg)

Revision paths for Euro Area GDP (Sources: BEA, Eurostat)
...
![](reference/figures/README-readme-example-1.png)
