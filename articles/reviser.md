...
often easier in **long (tidy) format**, which consists of:
...
- Calculate revisions:
  ...
  Revisions](https://docs.ropensci.org/reviser/articles/understanding-revisions.md)
  for more details.
- Analyze the revisions:
  ...
  Statistics](https://docs.ropensci.org/reviser/articles/revision-analysis.md)
  for more details.
- Identify the first efficient release:
  ...
  Identification](https://docs.ropensci.org/reviser/articles/efficient-release.md)
  for more details.
